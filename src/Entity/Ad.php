...
class Ad
{
     ...
     * @Assert\Length(min=10,max=255, minMessage="Le titre doit faire plus de 10 caractères !", maxMessage="Le message doit faire moins de 255 caractères, allowEmptyString = false")
     */
    private $title;
